        ...
        <body name="foundation" pos="0 0 0.1">
            ...
            <body name="pole" pos="0 0 0">
                ...
                <body name="pole2" pos="0 1.2 0">
                    ...
                    <joint axis="0 0 1" name="joint2" pos="0 0 0" range="-40 40" type="hinge" frictionloss="1"/>
...
# save movie
media.write_video("result/fault_sim/act_friction/movie.mp4", frames, fps=60)
...
# 動画として保存 (ffmpegが必要)
ani.save("result/fault_sim/act_friction/error_field.mp4", writer='ffmpeg', dpi=dpi)
...
# plt.colorbar()  # カラーバーを追加
plt.savefig("result/fault_sim/act_friction/error_field.png", dpi=300)
plt.show()